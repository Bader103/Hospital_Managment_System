...
export default function DoctorDetailPage() {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      console.log("the body for the data before submitting:",fd)
      const res = await fetch(`${API_BASE}/doctors`, {
        method: "POST",
        body: fd,
      });
      console.log("the data res from the api:",res)
      const data = await res.json().catch(() => null);
      console.log("the data for the doctors is:",data)
      console.log("the doctore added or not details:",)
      if (!res.ok) {
